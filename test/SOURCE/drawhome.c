...
void drawregister(void)
{
	...
	bar(280,120+240+50,280+140,120+240+40+50);             //*注册键    
    bar(560+30-90,120+240+50,560+30-10,120+240+40+50);     //*返回键

	puthz(35,35,"后勤集团食堂供应链管理系统注册界面",32,35,WHITE);
	puthz(280+25,120+240+4+50,"注册",32,62,WHITE);
	puthz(560-90+30+3,120+240+50+4,"返回",32,42,WHITE);
	...
	puthz(205+60,360,"后勤端",24,30,BLUE);
	puthz(325+60,360,"食堂端",24,30,BLUE);
	circle(190+60,370+2,8);//todo后勤圈圈
    circle(310+60,370+2,8);//todo食堂圈圈
